...
def parse_data(result_dir, data_type, category) -> pandas.DataFrame:
    ...
    header_names = [
        ...
        'feasibility_select_edge', 'feasibility_all_edge',
    ]
    column_names = [
        ...
        'average_feasibility_select_edge', 'average_feasibility_all_edge',
    ]
                            ...
                            for feasibility, cycle in [("h", "h"), ("h", "n"), ("n", "h"), ("n", "n"), ("n", "o"),
                                ...
                                for simulator in simulators_list:
                                    ...
                                    try:
                                        ...
                                        average_feasibility_select_edge = 0
                                        average_feasibility_all_edge = 0
                                        if len(df.columns) > 8:
                                        ...
                                        if len(df.columns) > 16:
                                            ...
                                            average_feasibility_select_edge = npy.mean(df['feasibility_select_edge'] / df['first_agent_arriving'])
                                            average_feasibility_all_edge = npy.mean(df['feasibility_all_edge'] / df['first_agent_arriving'])
                                    except:
                                        value = 0
                                        time = 0
                                    ...
                                    row = {
                                        ...
                                        "average_feasibility_select_edge": average_feasibility_select_edge,
                                        "average_feasibility_all_edge": average_feasibility_all_edge,
                                    }
